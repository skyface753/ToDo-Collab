...
def test_collection_create_read_update_delete():
    ...
    assert created_collection.created_at is not None
    assert created_collection.updated_at is not None
    first_updated_at = created_collection.updated_at
    ...
    assert updated_collection.created_at == created_collection.created_at
    assert updated_collection.updated_at > first_updated_at
    assert len(collection_crud.find_all()) == number_of_collections + 1
